      ...
      <div className="container-custom">
        ...
        {teamMembers.map((member, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
            className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-12 mb-24 last:mb-0 items-center border-b border-gray-100 pb-24 last:border-0`}
          >
            ...
            <div className="lg:w-1/2 space-y-6">
              <div>
                <h3 className="text-4xl font-heading font-bold text-navy mb-2">
                  {member.name}
                </h3>
                <p className="text-roseGold-500 text-base md:text-lg font-semibold tracking-wide">
                  {member.role}
                </p>
              </div>
              ...
              <p className="text-mutedText text-sm md:text-base leading-relaxed w-96">
                {member.description}
              </p>
              ...
              <div className="flex flex-wrap gap-3 pt-4">
                {member.expertise.map((skill, idx) => (
                  <span 
                    key={idx}
                    className="text-sm text-navy border-b border-roseGold-500"
                  >
                    {skill}
                  </span>
                ))}
              ...
              <div className="flex gap-4 pt-6">
                <a href="#" className="text-navy hover:text-roseGold-500 transition-colors">
